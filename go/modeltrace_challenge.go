...
// 挑战生成,忠实移植 sidecar modeltrace challenge.rs(算法源自 ModelTrace 仓库
// github.com/xqy2006/ModelTrace)。让模型凭第一反应输出 292..332 个 1..355 的整数,
// 措辞随机化以抗缓存/模板化,禁止用工具/代码/等差数列,采其真实数字分布。
